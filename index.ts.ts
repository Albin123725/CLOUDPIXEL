...
import { minecraftWorkflow } from "./workflows/minecraftWorkflow";
import { minecraftAgent } from "./agents/minecraftAgent";
...
// Register cron trigger to run the Minecraft workflow every 5 minutes
// Cron expression: */5 * * * * = every 5 minutes
registerCronWorkflow("*/5 * * * *", minecraftWorkflow);
